---
title: "Data analysis using statistical software: Basic Operation of R"
...
追加の引数を指定することで，グラフのタイトル，X軸・Y軸のラベル，マーカーの種類などを変更できる．

```{r plot_additional}
plot(x = swiss$Education, y = swiss$Fertility, pch = 20, 
     main = "Title of figure", xlab = "Education (% beyond primary school)", ylab = "Fertility")
```
...
元データは <http://biostat.mc.vanderbilt.edu/DataSets> から取得したもので，名前などの一部変数を除外している．
