...
* [Regression Analysis / 回帰分析](https://kurodaecon.github.io/dasp/html/regression.html) ([Old version before June 2025](https://kurodaecon.github.io/dasp/html/regression_old.html)) / [Stata do file](https://github.com/kurodaecon/dasp/blob/main/do/regression.do)
   * 基礎：最小二乗法 … `lm` 関数による推定，`lm` 関数を利用しない推定（数値計算による最適化を含む），検定
...
* 浅野 (2025) [早稲田大学「計量分析（政治）」補助教材](https://www.asanoucla.com/%E8%A8%88%E9%87%8F%E5%88%86%E6%9E%90-%E8%A3%9C%E5%8A%A9%E6%95%99%E6%9D%90-r/)
...
* 津田 (2025) [Rによる統計入門](https://htsuda.net/stats/) ... 回帰分析と因子分析がメイン
-->
