...
# 偏差
lines(c(1, 3), rep(0.98, 2), col = "blue", lty = 2, lwd = 2)
lines(c(2, 3), rep(0.93, 2), col = "blue", lty = 2, lwd = 2)
lines(c(6, 3), rep(0.88, 2), col = "blue", lty = 2, lwd = 2)
text(c(2, 2.5, 4.5), c(.97, .92, .87), labels = paste0("dev = ", c(-2, -1, 3)), col = "darkblue")
text(c(2, 2.5, 4.5), c(.955, .905, .855), labels = paste0("dev^2 = ", c(4, 1, 9)), col = "darkblue")
```
...
$X_1, X_2, \ldots, X_n$ を平均 $\mu$ 分散 $\sigma^2$ の同一分布に独立に従う確率変数とみなす．
...
$$ \therefore E \left[ \frac{1}{n-1} \sum_i (X_i - \bar{X}) \right] = \sigma^2 $$
</div>
